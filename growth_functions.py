...
def poly_quad4(params: np.ndarray, X: np.ndarray):
...
def gaussian(params: np.ndarray, X: np.ndarray):
...
def gaussian_target(params: np.ndarray, X: np.ndarray):
...
def step(params: np.ndarray, X: np.ndarray):
...
def staircase(params: np.ndarray, X: np.ndarray):
...
def triangle(params: np.ndarray, X: np.ndarray):
    r"""Gauss function
...
def identity(params: np.ndarray, X: np.ndarray):
    """Identity function
